...
<div class="game-body">
    ...
    <div class="game-box">
        <form method="post" action="{{ settings.get('website_url') }}admin/thefts/?new=true">
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="theft_name">Theft Name</label>
                        <input class="form-control" id="theft_name" name="theft_name" autocomplete="off">
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="theft_chance">Theft Chance</label>
                        <input class="form-control" type="number" id="theft_chance" name="theft_chance" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" id="theft_max_damage" name="theft_max_damage" autocomplete="off">
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group">
